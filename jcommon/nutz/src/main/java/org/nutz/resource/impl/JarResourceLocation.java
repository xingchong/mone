...
import org.nutz.lang.util.ZipUtils;
...
public class JarResourceLocation extends ResourceLocation {
    ...
    public JarResourceLocation(URL url) throws IOException {
        ...
        try {
            String urlStr = uriJarPrefix(this.uri, "!/");
            log.info("urlStr:" + urlStr);
            jarConn = (JarURLConnection) new URL(urlStr).openConnection();
            ...
            names.addAll(ZipUtils.names(this.jarPath, ".class"));
