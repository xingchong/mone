...
public class CodeReq {
    ...
    public String toString() {
        return "CodeReq(comment=" + getComment() + ", model=" + getModel() + ")";
    }
    ...
    public static class CodeReqBuilder {
        ...
        public CodeReqBuilder model(String model) {
            this.model = model;
            return this;
        }

        public CodeReq build() {
            return new CodeReq(this.comment, this.model);
        }

        public String toString() {
            return "CodeReq.CodeReqBuilder(comment=" + this.comment + ", model=" + this.model + ")";
        }
    }
