...
public class ZDataTagList implements Serializable {
    ...
    public void setList(List<ZDataTags> list) {
        this.list = list;
    }

    public boolean equals(Object o) {
        if (o == this) return true;
        if (!(o instanceof ZDataTagList)) return false;
        ZDataTagList other = (ZDataTagList) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ZDataTagList;
    }
    ...
    public String toString() {
        return "ZDataTagList(pageNum=" + getPageNum() + ", pageSize=" + getPageSize() + ", total=" + getTotal() + ", list=" + getList() + ")";
    }
...
/* Location:              /Users/admin/Documents/git/mi/docker_image_jar/run.mone.zip!/run/mone/ai/z/dto/ZDataTagList.class
