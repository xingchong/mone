...
public class WordQryPageReq extends ZPageReq implements Serializable {
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof WordQryPageReq)) return false;
        WordQryPageReq other = (WordQryPageReq) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof WordQryPageReq;
    }
    ...
    public String toString() {
        return "WordQryPageReq(name=" + getName() + ", type=" + getType() + ", available=" + getAvailable() + ", isRegexMatch=" + getIsRegexMatch() + ", isCaseSensitive=" + getIsCaseSensitive() + ")";
    }
...
/* Location:              /Users/admin/Documents/git/mi/docker_image_jar/run.mone.zip!/run/mone/ai/z/dto/sensitiveword/WordQryPageReq.class
