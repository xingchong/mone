...
public class ZDataTypesList implements Serializable {
    ...
    public void setList(List<ZDataTypes> list) {
        this.list = list;
    }

    public boolean equals(Object o) {
        if (o == this) return true;
        if (!(o instanceof ZDataTypesList)) return false;
        ZDataTypesList other = (ZDataTypesList) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof ZDataTypesList;
    }
    ...
    public String toString() {
        return "ZDataTypesList(pageNum=" + getPageNum() + ", pageSize=" + getPageSize() + ", total=" + getTotal() + ", list=" + getList() + ")";
    }
    ...
    public List<ZDataTypes> getList() {
        /* 18 */
        return this.list;
    }
}
...
/* Location:              /Users/admin/Documents/git/mi/docker_image_jar/run.mone.zip!/run/mone/ai/z/dto/ZDataTypesList.class
